...
if (@!defined('_MD_' . constant($capsDirName . '_DIRNAME'))) {
    define('_MD_' . $capsDirName . '_DIRNAME', $moduleDirName);
    define('_MD_' . $capsDirName . '_PATH', XOOPS_ROOT_PATH . '/modules/' . constant('_MD_' . $capsDirName . '_DIRNAME'));
    define('_MD_' . $capsDirName . '_URL', XOOPS_URL . '/modules/' . constant('_MD_' . $capsDirName . '_DIRNAME'));
    // define('_MD_' . $capsDirName . '_ADMIN', constant('_MD_' . $capsDirName . '_URL') . '/admin/index.php');
    define('_MD_' . $capsDirName . '_ROOT_PATH', XOOPS_ROOT_PATH . '/modules/' . constant('_MD_' . $capsDirName . '_DIRNAME'));
    //define('_MD_' . $capsDirName . '_AUTHOR_LOGOIMG', constant($capsDirName . '_URL') . '/assets/images/logoModule.png');
