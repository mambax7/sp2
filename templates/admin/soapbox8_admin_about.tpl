    ...
    <table class="width90 floatcenter0">
        <tr>
            <td class="aligntop width45">
                <fieldset>
                    ...
                    <div>
                        ...
                        <br>
                        <!--label><{$smarty.const._AM_SOAPBOX8_ABOUT_RELEASEDATE}></label><text><{$module_release}></text><br /-->
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_DESCRIPTION}></label>
                        <text><{$module_description}></text>
                        <br>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_AUTHOR}></label>
                        <text><{$module_author}></text>
                        <br>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_CREDITS}></label>
                        <text><{$module_credits}></text>
                        <br>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_LICENSE}></label>
                ...
                <fieldset>
                    <legend class="Slideshow_MediumTitle bold shadowlight"><{$smarty.const._AM_SOAPBOX8_ABOUT_MODULE_INFO}></legend>
                    <div>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_RELEASEDATE}></label>
                        <text class="bold"><{$module_update_date}></text>
                        <br>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_MODULE_STATUS}></label>
                        <text><{$module_status}></text>
                        <br>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_WEBSITE}></label>
                ...
                <fieldset>
                    <legend class="Slideshow_MediumTitle bold shadowlight"><{$smarty.const._AM_SOAPBOX8_ABOUT_AUTHOR_INFO}></legend>
                    <div>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_AUTHOR_NAME}></label>
                        <text><{$module_author}></text>
                        <br>
                        <label><{$smarty.const._AM_SOAPBOX8_ABOUT_WEBSITE}></label>
            ...
            <td class="aligntop width50">
                <{if $changelog}>
                    <fieldset>
                        <legend class="Slideshow_MediumTitle bold shadowlight"><{$smarty.const._AM_SOAPBOX8_ABOUT_CHANGELOG}></legend>
